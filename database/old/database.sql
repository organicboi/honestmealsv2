...
CREATE TABLE public.profiles (
  ...
  address text,
  phone_number text,
  role USER-DEFINED DEFAULT 'standard_user'::user_role,
...
CREATE TABLE public.referral_codes (
  ...
  referral_type USER-DEFINED NOT NULL,
  is_active boolean DEFAULT true,
  usage_limit integer,
...
CREATE TABLE public.referral_rewards_config (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  referral_type USER-DEFINED NOT NULL UNIQUE,
  referrer_reward_type USER-DEFINED NOT NULL,
  referrer_reward_value numeric NOT NULL,
  referred_reward_type USER-DEFINED NOT NULL,
